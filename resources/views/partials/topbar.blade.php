                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/dashboard') }}">
                        ...
                        <b class="logo-icon">
                            ...
                            <!-- Dark Logo icon -->
                            <img src="{{ url('') }}/assets/images/logo-icon.svg" width="45px" alt="homepage" class="dark-logo" />
                            <!-- Light Logo icon -->
                            <img src="{{ url('') }}/assets/images/logo-light-icon.svg" width="45px" alt="homepage" class="light-logo" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        <span class="logo-text">
                             <!-- dark Logo text -->
                             <img src="{{ url('') }}/assets/images/logo-text.svg" width="85px" alt="homepage" class="dark-logo" />
                             <!-- Light Logo text -->
                             <img src="{{ url('') }}/assets/images/logo-light-text.svg" width="85px" class="light-logo" alt="homepage" />
                        </span>
                    </a>
                    <!-- ============================================================== -->
                    <!-- End Logo -->
